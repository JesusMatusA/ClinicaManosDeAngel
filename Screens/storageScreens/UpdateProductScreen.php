                ...
                <div class="storageFormAdd">
                    <form action="../../functions/storageFunctions/storageUpdateProduct.php" method="post" class="form">
                      <div class="leftBoxForm">
                        ...
                        <textarea type="text" maxlength="500" required autocomplete="off" placeholder="Descripción" name="productDescription" class="inputTextDesign textarea"><?php echo $description;?></textarea>
                        <input type="text"    maxlength="50" required autocomplete="off" value="<?php echo $category;?>" placeholder="Categoría" name="productCategory" class="inputTextDesign" />
                      </div>  
                      <div class="rightoxForm">
                        <input type="text"    maxlength="50" required autocomplete="off" value="<?php echo $subCategory;?>" placeholder="Sub Categoría"       name="productSubCategory" class="inputTextDesign" />
                        <input type="number"  maxLength="3" required autocomplete="off" value="<?php echo $stockMin;?>"    placeholder="Stock Máximo"        name="stockMax" min="1"   class="inputTextDesign" />
                        <input type="number"  maxlength="3" required autocomplete="off" value="<?php echo $stockMax;?>"    placeholder="Stock Mínimo"        name="stockMin" min="1"   class="inputTextDesign" />
